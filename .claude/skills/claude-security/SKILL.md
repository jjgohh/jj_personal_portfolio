...
allowed-tools:
  ...
  - Bash(python3 ".claude/skills/claude-security/scripts/render_report.py" *)
  - Bash(python3 ".claude/skills/claude-security/scripts/write_scan_meta.py" *)
  - Bash(python3 ".claude/skills/claude-security/scripts/patch_artifacts.py" *)
  - Bash(sleep *)
...
- [SCRIPTS — helper scripts directory](.claude/skills/claude-security/scripts)
